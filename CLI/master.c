...
int main(int argc, char* argv[]){
    ...
    const int verbose = atoi(argv[argc-1]); // 1: some verbosity; 2: full verbosity
    ...
    */
    ...
    // Call the emulator
    EucEmu(&cosmo_params[0], &zvec[0], nz, &k_values, &length_k_values, &boost, &length_boost, verbose);
